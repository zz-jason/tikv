...
use rocksdb::{DBOptions, BlobdbOptions, ColumnFamilyOptions, BlockBasedOptions, DBCompressionType};
use fs2::FileExt;
...
fn run_raft_server(pd_client: RpcClient,
    ...
    let mut blobdb_opts = BlobdbOptions::new();
    blobdb_opts.compression(DBCompressionType::Lz4);
    ...
    let cfs_opts =
        vec![rocksdb_util::CFOptions::new(CF_DEFAULT, ColumnFamilyOptions::new()),
